...
#
#     from intgraph import metadata
#
# However, when we do this, we also import `intgraph/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'intgraph_cli = intgraph.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'intgraph_gui = intgraph.gui:entry_point'
        # ]
    }
)
